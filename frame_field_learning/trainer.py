        ...
        for i, batch in enumerate(epoch_iterator):
            ...
            if split_name == "train" and (iter_step % log_steps == 0) or \
                ...
                if self.rank == 0:
                    ...
                    # Save image overlaid with seg + frame field to tensorboard:
                    if "seg" in pred:
                        ...
                        writer.add_images('seg_ff', image_seg_display, iter_step)
                    
                    ## added by me
                    # Save image overlaid with seg to tensorboard:
                    if "seg" in pred:
                        image_seg_display = plot_utils.get_tensorboard_image_seg_display(image_display, pred["seg"])
