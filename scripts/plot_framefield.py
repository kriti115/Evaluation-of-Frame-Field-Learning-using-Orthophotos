...
def save_plot_crossfield(framefield, out_filepath):
    # Setup plot
    height = framefield.shape[0]
    width = framefield.shape[1]
    #f, axis = plt.subplots(1, 1, figsize=(width // 10, height // 10)) # original
    f, axis = plt.subplots(1, 1, figsize=(width // 50, height // 50)) # added by me 24.05.2022
...
def main():
    ...
    save_plot_crossfield(framefield, args.out_filepath)
